...
export default function OnBoardingThird() {
    ...
    return (
        ...
        <OnBoarding buttonName="Get Started" title="Secure & Reliable Transport" description="Ensure safe deliveries with verified movers, secure packaging, and real-time tracking updates." routeName="SignIn" images={require('@/assets/images/onBoardingThird.png')} widthSize3="w-[24px] bg-blue-400" widthSize1="w-[6px] bg-gray-300" widthSize2="w-[6px] bg-gray-300" />
    );
}
