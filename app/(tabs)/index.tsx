            ...
            <View className='flex-row items-center justify-between my-6'>
              <View className='relative w-[72px] h-[72px]'>
                ...
                <View className='absolute inset-0 items-center justify-center'>
                  <Image
                    source={require("@/assets/images/Ahmed-ReFat.jpg")}
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <View className='px-6'>
                ...
                <View className='mb-6'>
                  ...
                  <View className='flex-row flex-wrap justify-between gap-2 mb-20'>
                    <View className='items-center w-32 h-32'>
                      <Image source={images.packing} className='size-28' />
                      <Text>Packing</Text>
                    </View>
                    <View className='items-center w-32 h-32 '>
                      <Image source={require("@/assets/images/loading.png")} className='size-28' />
                      <Text>Loading</Text>
                    </View>
                    <View className='items-center w-32 h-32 '>
                      <Image source={require("@/assets/images/unloading.png")} className='size-28' />
                      <Text>Unloading</Text>
                    </View>
                    <View className='items-center w-32 h-32 '>
                      <Image source={require("@/assets/images/packing-3d.png")} className='size-28' />
                      <Text>Packing</Text>
                    </View>
                    <View className='items-center w-32 h-32 '>
                      <Image source={require("@/assets/images/loading.png")} className='size-28' />
